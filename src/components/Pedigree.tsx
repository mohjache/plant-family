...
import type { Pedigree as PedigreeData, PedigreeNode } from "@convex/plants";
 ...
 * a generation is wide. See docs/adr/0004-inventory-first-information-architecture.md.
 */
export function Pedigree({ data }: { data: PedigreeData }) {
	...
	const parentsByChild = new Map<
		string,
		{ parentId: Id<"plants">; role?: "seed" | "pollen" }[]
	>();
